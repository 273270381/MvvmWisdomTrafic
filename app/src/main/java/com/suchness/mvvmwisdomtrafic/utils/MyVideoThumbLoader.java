...
public class MyVideoThumbLoader {
    ...
    public  class MyBobAsynctack extends AsyncTask<String, Void, Bitmap> {
        private WeakReference<MyImageView> imgView;
        private String path;
        private int width;
        private int height;
        ...
        protected Bitmap doInBackground(String... params) {
            ...
            try {
                ...
                if (bitmap == null) {
                    //将drawable转bitmap
                    bitmap = android.graphics.BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.fail_end);
                }
        ...
        protected void onPostExecute(Bitmap bitmap) {
            //if (imgView.getTag().equals(path)) {// 通过 Tag可以绑定 图片地址和
                ...
                imgView.get().setImageBitmap(bitmapRound(bitmap,10));
          //  }
        }
    }
